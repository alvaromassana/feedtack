# Plantilla: el correo con el enlace personal

Es una **plantilla**, no un borrador. Para mandarlo de verdad se prepara con `/draft` en el hilo
donde ya se está hablando de la revisión, y lo envía Álvaro.
...
- El GIF que se incrusta es `guia/clips/ejemplo-1-titular.gif`. En correo va el GIF, no el mp4.
- Un correo, un asunto: esto no se mezcla con el estado del proyecto ni con dinero.

---

## Español

**Asunto:** Para comentar la web: tu enlace
...
Al abrirlo verás una pestaña en el lado derecho. Pulsas ahí, señalas lo que quieras comentar y nos
...
**Subject:** Your link to comment on the site

Hi NAME,

The site is ready for you to look at and comment on directly, with no lists or screenshots going
...
When you open it you will see a tab on the right hand side. Click there, point at whatever you want
